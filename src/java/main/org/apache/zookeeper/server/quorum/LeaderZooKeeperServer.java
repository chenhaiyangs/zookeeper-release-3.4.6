 ...
 * 多了ProposalRequestProcessor，CommitProcessor，ToBeAppliedRequestProcessor。
 * processors:
 * PrepRequestProcessor -> ProposalRequestProcessor ->CommitProcessor -> Leader.ToBeAppliedRequestProcessor ->FinalRequestProcessor
 * 启动Leader的ZookeeperServer，实际上主要就是请求链不同
 */
public class LeaderZooKeeperServer extends QuorumZooKeeperServer {
    CommitProcessor commitProcessor;

    /**
     * 初始化LeaderZookeeperServer
     * @param logFactory logFactory
     * @param self self;
     * @param treeBuilder treeBilder
     * @param zkDb zkDb
     * @throws IOException ;
     */
