...
public class ZooKeeperServer implements SessionExpirer, ServerStats.Provider {
    ...
    public interface DataTreeBuilder {
        /**
         * 生成数据tree，zookeeper中是以树为结构构造数据的
         * @return ;
         */
        DataTree build();
    }
    ...
    /**
     * 构造调用链： prepRequest->syncRequest->FinalRequest
     */
     ...
     * 处理连接请求
     * @param cnxn cnxn
     * @param incomingBuffer incomingBuffer
     * @throws IOException ;
     */
