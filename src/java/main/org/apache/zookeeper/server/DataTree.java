...
public class DataTree {
     ...
     * 是特殊节点吗？主要是判断是不是zzookeeper路径下的几个path
    ...
    public String createNode(String path, byte data[], List<ACL> acl,
        ...
        //触发trigger。一个是data的监听，一个是子节点的监听
     ...
     * dump watcher的摘要，其实就是调用的toString方法
    ...
    /**
     * remove连接时对应的，要把它的Watcher节点也remove掉
     * @param watcher watcher节点
     */
    ...
    /**
     * 设置所有的watcher
     * @param relativeZxid 相对zxid
     * @param dataWatches 数据watchers
     * @param existWatches 存在的watchers
     * @param childWatches 子节点watchers
     * @param watcher ?
     */
    public void setWatches(long relativeZxid, List<String> dataWatches,
        ...
        for (String path : dataWatches) {
            ...
            if (node == null) {
                ...
                //如果node的最后的zxid大于客户端端传过来的相对的zxid，则触发一次通知
